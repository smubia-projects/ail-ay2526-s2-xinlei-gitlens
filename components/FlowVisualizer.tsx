...
import { X, ExternalLink, Code2, FileCode, Info, ArrowRight } from 'lucide-react';
      ...
      <div className="flex-1 flex relative overflow-hidden">
        ...
        {data.usage_examples && data.usage_examples.length > 0 && (
          <aside className="w-96 border-l border-slate-800 bg-slate-900/50 backdrop-blur-md flex flex-col overflow-hidden animate-in slide-in-from-right duration-500">
            <div className="p-4 border-b border-slate-800 flex items-center gap-2 text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">
              <Info size={14} className="text-blue-500" /> Usage Examples
            </div>
