          ...
          <div className="relative max-w-md w-full space-y-8">
            <div className="flex flex-col items-center gap-4">
              <div className="relative">
                ...
                <div className="relative bg-neutral-900 border border-white/20 p-6 rounded-3xl shadow-2xl shadow-white/5">
              ...
              <div className="space-y-2">
                <h2 className="text-2xl font-black text-white uppercase tracking-tighter">
                  Indexing <span className="text-neutral-400">Repository</span> {loadingTime !== undefined && <span className="text-neutral-500 ml-2">({loadingTime}s)</span>}
                </h2>
            ...
            <div className="bg-black/50 border border-white/10 rounded-2xl p-6 space-y-4 text-left">
            ...
            <div className="pt-4">
              ...
              <p className="text-[10px] text-neutral-500 mt-3 font-mono uppercase tracking-widest">
